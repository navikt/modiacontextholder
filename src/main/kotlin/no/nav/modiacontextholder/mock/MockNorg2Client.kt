...
class MockNorg2Client : Norg2Client {
    override fun hentAlleEnheter(): List<Enhet> =
        listOf(
            Enhet("0001", "Test enhet", "test", "LOKAL", "0", oppgavebehandler = true),
            Enhet("0002", "Test annen enhet", "test", null, "1", oppgavebehandler = false),
            Enhet("9999", "Test enhet", "test", "KO", "2", oppgavebehandler = null),
        )
}
